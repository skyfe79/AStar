...
HRESULT CD3DFont::RestoreDeviceObjects()
{
    ...
    if( SUCCEEDED( m_pd3dDevice->GetDirect3D( &pd3d9 ) ) )
    {
        ...
        if( SUCCEEDED( m_pd3dDevice->GetRenderTarget( 0, &pSurf ) ) )
        {
			...
			d3d::Release<LPDIRECT3DSURFACE9>( pSurf );
        }
        d3d::Release<LPDIRECT3D9>( pd3d9 );
    }
...
HRESULT CD3DFont::InvalidateDeviceObjects()
{
    ...
    d3d::Release<LPDIRECT3DSTATEBLOCK9>( m_pStateBlockSaved );
    d3d::Release<LPDIRECT3DSTATEBLOCK9>( m_pStateBlockDrawText );
